...
- Name: rewards.spec.ts >> RewardsScreen >> shows sticker collection
- Location: e2e\rewards.spec.ts:11:3
...
Call log:
  - navigating to "http://localhost:5174/rewards", waiting until "load"
